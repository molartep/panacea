...
L2_E_first_hours <- L2_E_hours[1:11, c(2,6)]
L2_E_second_hours <- L2_E_hours[13:25, c(2,6)]
L2_E_third_hours <- L2_E_hours[27:39, c(2,6)]
L2_E_fourth_hours <- L2_E_hours[41:52, c(2,6)]
...
L2E_dates3 <- bizdays(L2_E_dates[which(L2_E_dates$p_level == maxP3),1]$date,
                      L2_E_dates[which(L2_E_dates$p_level == minP3),1]$date)
