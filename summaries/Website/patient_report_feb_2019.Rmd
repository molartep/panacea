---
title: "Velvack & Panacea Patient Report"
author: "Martin Olarte"
date: "2/4/2019 - 4/12/2019"
output:
  html_document:
    css: style.css
    highlight: tango
...
Cellular Repolarization focuses on the primary pathology and reducing uncontrolled cell proliferation, but according to patients' testimonies it also has various additional benefits:

* Reduced fatigue and increased levels of energy throughout the day.

* Neuropathic and muscular pain relief.

* Increased apettite.

* Reduced skin redness and return to normal pigmentation.

* Reduction of other side-effects caused by alternative, simultaneous treatments like radiation or chemotherapy.
...
* Dermatitis at the site of electrodes, which is promptly treated by isolation of affected skin surfaces from adhesives or pressure.
...
## Tumor Treating Fields (TTFs){.tabset .tabset-fade .tabset-pills}

### Background

<br />

Tumor Treating Fields (TTFs) treatment is a type of electromagnetic field treatment that uses low-intensity electrical fields delivered through noninvasive transducer arrays that are placed locoregionally around the anatomic region of the tumor, in order to suppress cancer cell proliferation in the body. The effectiveness of TTFs is considered to be similar to that of chemotherapy. However, chemotherapy has various side effects that affect normal cells, and is not recommended to be used for long term treatment due to drug resistance and accumulation of toxicity. On the other hand, TTFs is considered a safe treatment with no association to drug resistance or accumulation of toxicity. Also, it is possible to use TTFs with other conventional treatments such as chemotherapy, and there is even thought to be synergistic effects using TTFs with immunotherapy for specific types of cancer.

TTFs' effects on dividing cells result from the multitude of charged macromolecules and organelles responsible for key processes in the mitotic process. Structural change or dislocation of those cellular components may alter their physiologic function, and ultimately disrupt normal mitosis. The effects of
TTFs on various cellular processes can be explained by two fundamental physical principles: _dipole alignment_ and _dielectrophoresis_.

* A _dipole_ refers to the separation of positive and negative charges within a molecule. Under a uniform alternating electric field, any charged molecule will oscillate in an attempt to align itself appropriately parallel to the direction of the electric force vector it is exposed to. Key macromolecules and organelles responsible for mitosis and cytokinesis are highly polar, and their random movement, which is critical for their function, can be disrupted by the application of localized electric fields.

* The process of _dielectrophoresis_ refers to the phenomenon where, in a nonuniform electric field, a force is exerted on polar molecules, which leads them to migrate toward a region of high-field density.
...
TTFs are nonuniformly distributed within the treated region based on multiple parameters, which include the geometry of the treated organ, the distance between transducer arrays applied to the patient's skin, and the tissue's dielectric properties. The fields do not attenuate in correlation to the distance from the array, and may therefore be used for the treatment of deeply located tumors. As electric fields do not have a half-life time, TTFs are continuously delivered during the course of treatment.

The electromagnetic fields affect cells at different stages of mitosis differently:

* In cells at an early stage of mitosis (before the mitotic spindle is formed), electromagnetic fields impede the polymerization of microtubules by eliminating the normal randomized movement of the tubulin subunits within the cytoplasm during metaphase. This, in turn, leads to metaphase arrest, prolonged mitosis, and ultimately cell death.

* Alternatively, in the cells where the spindle formation has completed, the electric field distribution becomes uneven and a high-intensity field is formed at the narrow furrow region because of the dividing cell's hour-glass shape during metaphase. The Septin complex, which is responsible for the physiologic localization of contractile proteins leading to the normal division of the cell into two daughter cells, is dislocated as a result of TTF-exerted dielectrophoresis. This effect, which happens towards the end of telophase, can lead to violent cytoplasmic blebbing and cellular death, or to abnormal chromosomal segregation leading to aneuploidy in daughter cells, and a subsequent decrease in clonogenic potential. Septin has a greater dipole moment than tubulin (2711 Debyes vs. 1660 Debyes). However, due to the faster dynamics of assembly/disassembly of tubulin, the effects of TTFs on microtubules might be more significant.

The above effects of TTFs ultimately lead to caspase-dependent or independent apoptosis, and also increase the cellular expression of immunogenic cell death markers.
...
Tumor Treating Fields focus on reducing the size and activity of the primary tumor while reducing uncontrolled cell proliferation.
...
* To date, no TTF-related adverse events have been reported as a result of genetic alterations or other mitotic effects in normally dividing tissues. Further experiments would clarify these effects in greater detail, both in healthy and pathologic tissues.
...
April 9, 2019 | April 9, 2019 | Ureteric Stent     
...
![C1J Electrode Placement](images/C1-J.png)
...
Pending       | Pending       | Left Mastectomy
...
<br />
* The <b>Left Thyroid Lobe Nodules</b> refer to two hypoechoic nodules located towards the middle region and lower pole of the left thyroid lobe. According to the Ultrasound on November 2018, these nodules and two microcysts have characteristics that are very compatible with a diffuse multinodular goiter, and Doppler analysis describes them as cold with no type of vasculature.
<br />
...
* L2-E's third session saw a drastic increase in the use of the Tumor Treating Fields (TTFs) Device, as well as an increase in overall treatment hours.
...
grid.arrange(top = "L3-K Polarity", first_graph_L3_K, second_graph_L3_K, third_graph_L3_K, fourth_graph_L3_K, fifth_graph_L3_K, sixth_graph_L3_K, ncol=2, left = "Polarity", bottom = "Total Treatment Duration (Hrs)")
```
...
L3K_timeline <- data.frame(
  ...
  start = c("2018-10-29", "2018-12-03", "2019-01-14", "2019-02-11", "2019-03-11", "2019-04-08",
  ...
  end   = c("2018-11-03", "2018-12-15", "2019-01-19", "2019-02-14", "2019-03-16", "2019-04-13",
            NA, NA, NA, NA, NA,
            NA, NA,
            NA, NA, NA, NA, NA,
            NA,
  ...
  group = c(rep(NA, 6), rep("img", 12), rep("blood", 6)),
  
  type = c(rep("background", 6), rep("point", 18))
)
...
timevis(data = L3K_timeline, groups = L3K_groups, showZoom = FALSE, zoomFactor = 0.2, options = list(zoomable = TRUE, min = "2018-07-01", max = "2019-05-20", start = "2018-07-01", end  = "2019-05-20", zoomMin = 1080000000))
```
...
L3K_signif <- data.frame(
  ...
  start = c("2018-10-29", "2018-12-03", "2019-01-14", "2019-02-11", "2019-03-11", "2019-04-08",#sessions
            "2018-11-03", "2018-12-15", "2019-01-19", "2019-02-14", "2019-03-16", "2019-04-13", #polarity
  ...
  end   = c("2018-11-03", "2018-12-15", "2019-01-19", "2019-02-14", "2019-03-16", "2019-04-08", #sessions
            rep(NA, 6), #polarity
  ...
  group = c(rep(NA, 6), #sessions
            rep("polar", 6), #polarity
            rep("wbc", 3), #wbc
            rep("rbc", 3), #rbc
            rep("hgb", 3), #hgb
            rep("hct", 3), #hct
  ...
  type = c(rep("background", 6), rep("point", 90))
)
...
<br />
* The <b>Left Parietal Lobe Focus</b> was stable according to the CT Scan on July 17, 2018, but in August 28 of the same year a vague enhancement was noted that could represent a capillary tube dilatation or development of venous anomaly. This was resolved in October 8, 2018, and has only improved since then.
<br />
...
<br />
* The <b>Hepatic Lesions</b> described in the CT Scan on February 27, 2019 had 4 individual lesion measurements (1.5 cm, 1.1 cm, 0.4 cm, and 0.9 cm). The MRI on March 4, 2019 stated that there are 5 hepatic masses with T2 signal iso-intensity to slight intermediate signal hyperintensity ranging in size from a few millimeters to 14 mm which do not completely enhance, suspicious for metastatic disease.
<br />
...
![L3K Electrode Placement](images/L3-K.png)
...
<h4> Study design flaws:</h4>
  * Lack of a control group to properly compare and measure progress against a baseline (completely healthy patient).
  * Irregular monitoring (polarity measurements and medical test results) of each patient.
  * Small patient sample size (n = 7) without randomized selection.
  * Treatment session hours and break irregularity.
  
  <br />

<h4> Statistic Limitations:</h4> 
  * Inaccuracies due to human error in data collection and analysis.
  * Inaccuracies and inconsistencies in medical test results.
  * Lack of consistent polarity measurements affects the accuracy and significance of statistical analysis.
  * Extrapolation between patients and to larger populations is not recommended due to abundant individual distinctions between patients.

  <br />
<h4> Statistic Information:</h4>

  * Regarding _Total Treatment Hours vs Polarity_ plots:
  
      + The linear regression models were fitted using the `geom_smooth(method = "lm", y ~ x)` function in R.
      
      <br>

  * Regarding _Polarity through Time_ plots:
  ...
  * Regarding _Correlation Summaries_:
      ...
      + The __CI bounds__ refer to a 95% asymptotic compatibility interval for the correlation coefficient (R) estimates based on [Fisher's Z transform](https://en.wikipedia.org/wiki/Fisher_transformation), on cases of at least 4 complete pairs of observations (polarity value and therapy hours).
...
* [De-identification Procedure - HIPAA](https://www.hhs.gov/hipaa/for-professionals/privacy/special-topics/de-identification/index.html#protected)

* [Adhesive Electrode Precautions - ITO](http://www.itocoltd.com/notice/adhesive-electrode.html)

* [SUV max - NIH](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3026294/)

* [Leukocytes - NCI](https://www.cancer.gov/publications/dictionaries/cancer-terms/def/leukocyte)

* [Lymph Node Measurement Procedure - University Hospital of Leipzig](http://ceur-ws.org/Vol-1476/Proceedings_CURAC_2011_Paper_10.pdf)

* [Prostate Measurement Procedure - NIH](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2842183/)

* [Multinodular Goiter - Columbia University](http://columbiasurgery.org/conditions-and-treatments/multinodular-goiter)

<br>

* ["Tumor-Treating Fields: A Fourth Modality in Cancer Treatment"](http://clincancerres.aacrjournals.org/content/clincanres/24/2/266.full.pdf)

* ["Targeted treatment of cancer with radiofrequency electromagnetic fields amplitude-modulated at tumor-specific frequencies"](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3845545/)

* ["Mitotic Spindle Disruption by Alternating Electric Fields Leads to Improper Chromosome Segregation and Mitotic Catastrophe in Cancer Cells"](https://www.nature.com/articles/srep18046)

* ["Treating cancer with amplitude-modulated electromagnetic fields: a potential paradigm shift, again?"](https://www.nature.com/articles/bjc2011576)

* ["Cancer cell proliferation is inhibited by specific modulation frequencies"](https://www.nature.com/articles/bjc2011523)
