...
first_grobsC1J <- list(first_graph_C1_J, second_graph_C1_J, third_graph_C1_J)
second_grobsC1J <- list(fourth_graph_C1_J)

C1JFINAL <- grid.arrange(top = "C1-J Polarity", ncol=3,
