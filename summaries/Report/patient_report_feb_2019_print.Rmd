...
C1J_final_date_graph <- C1J_dategraph + geom_text(aes(x = C1J_first_day, y = first_C1_J$`Polarity level`[which(first_C1_J$`Polarity level`>0)][1],
  ...
  geom_text(aes(x = C1J_lab4x, y = C1J_lab4y + 5, color = "46", label = "+ 26.7",
                angle = 14), size = 3) + labs(color = "Days Without\nTreatment") + theme(legend.position = "none", 
...
B1S_final_date_graph <- B1S_dategraph + geom_text(aes(x = B1S_first_day, y = first_B1_S$`Polarity level`[which(first_B1_S$`Polarity level`>0)][1],
  ...
  geom_text(aes(x = B1S_lab2x, y = B1S_lab2y + 5, color = "38", label = "+ 56.4",
                angle = 36), size = 3) + labs(color = "Days Without\nTreatment") + theme(legend.position = "none", 
                                                                                           axis.title.x = element_text(margin = margin(t = 15, r = 0, b = 0, l = 0)),
                                                                                           axis.title.y = element_text(margin = margin(t = 0, r = 15, b = 0, l = 0)))
...
L2E_final_date_graph <- L2E_dategraph + geom_text(aes(x = L2E_first_day, y = first_L2_E$`Polarity level`[which(first_L2_E$`Polarity level`>0)][1],
  ...
  geom_text(aes(x = L2E_lab4x, y = L2E_lab4y + 5, color = "24", label = "+ 2.4",
                angle = 7), size = 3) + labs(color = "Days Without\nTreatment") + theme(legend.position = "none", 
                                                                                           axis.title.x = element_text(margin = margin(t = 15, r = 0, b = 0, l = 0)),
                                                                                           axis.title.y = element_text(margin = margin(t = 0, r = 15, b = 0, l = 0)))
...
H1A_final_date_graph <- H1A_dategraph + geom_text(aes(x = H1A_first_day, y = first_H1_A_hours$`Polarity level`[which(first_H1_A_hours$`Polarity level`>0)][1],
  ...
  geom_text(aes(x = H1A_lab4x, y = H1A_lab4y + 2, color = "25", label = "+ 1.7",
                angle = 5), size = 3) + labs(color = "Days Without\nTreatment") + theme(legend.position = "none", 
                                                                                           axis.title.x = element_text(margin = margin(t = 15, r = 0, b = 0, l = 0)),
                                                                                           axis.title.y = element_text(margin = margin(t = 0, r = 15, b = 0, l = 0)))
...
L3K_final_date_graph <- L3K_dategraph + geom_text(aes(x = L3K_first_day, y = first_L3_K$`Polarity level`[which(first_L3_K$`Polarity level`>0)][1],
                                        ...
                                        geom_text(aes(x = L3K_last_day, y = tail(fourth_L3_K$`Polarity level`[which(fourth_L3_K$`Polarity level`>0)],1),
                                                      label = L3K_label_last), hjust = -0.1, vjust = 1, size = 3.5) +
  ...
  geom_text(aes(x = L3K_lab3x, y = L3K_lab3y + 5, color = "23", label = "+ 10.6",
                angle = 8), size = 3) + labs(color = "Days Without\nTreatment") + theme(legend.position = "none", 
                                                                                           axis.title.x = element_text(margin = margin(t = 15, r = 0, b = 0, l = 0)),
                                                                                           axis.title.y = element_text(margin = margin(t = 0, r = 15, b = 0, l = 0)))
...
L1J_final_date_graph <- L1J_dategraph + geom_text(aes(x = L1J_first_day, y = first_L1_J$`Polarity level`[which(first_L1_J$`Polarity level`>0)][1],
                                        ...
                                        geom_text(aes(x = L1J_last_day, y = tail(first_L1_J$`Polarity level`[which(first_L1_J$`Polarity level`>0)],1),
                                                      label = L1J_label_last), hjust = -0.1, vjust = 1, size = 3.5) + theme(legend.position = "none", 
                                                                                           axis.title.x = element_text(margin = margin(t = 15, r = 0, b = 0, l = 0)),
                                                                                           axis.title.y = element_text(margin = margin(t = 0, r = 15, b = 0, l = 0)))
...
## C1J{.tabset .tabset_fade .tabset_pills}
...
C1J_final_date_graph + ggtitle("C1-J Polarity through Time")
```
...
## B1S{.tabset .tabset_fade .tabset_pills}
...
B1S_final_date_graph + ggtitle("B1-S Polarity through Time")
```
...
## L2E{.tabset .tabset_fade .tabset_pills}
...
L2E_final_date_graph + ggtitle("L2-E Polarity through Time")
```
...
## H1A{.tabset .tabset_fade .tabset_pills}
...
H1A_final_date_graph + ggtitle("H1-A Polarity through Time")
```
...
## L3K{.tabset .tabset_fade .tabset_pills}
...
L3K_final_date_graph + ggtitle("L3-JK Polarity through Time")
```
...
## G1D{.tabset .tabset_fade .tabset_pills}
...
G1D_final_date_graph + ggtitle("G1-D Polarity through Time")
```
...
## L1J{.tabset .tabset_fade .tabset_pills}
...
L1J_final_date_graph + ggtitle("L1-J Polarity through Time")
```
