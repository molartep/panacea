...
G1_D_all <- list(G1_D_first_hours, G1_D_second_hours, G1_D_third_hours, G1_D_fourth_hours, G1_D_fifth_hours)
...
G1D_df_stats <- data.frame(Interval = c("1st", "2nd", "3rd", "4th", "5th"),
                           R = signif(G1_D_estims, 4),
                           Pval = signif(G1_D_pvalues, 4),
                           Lower = c(signif(G1_D_lower, 4), NA, NA),
                           Upper = c(signif(G1_D_upper, 4), NA, NA))

G1D_df_stats1 <- data.frame(Interval = c("1st", "2nd", "3rd", "4th", "5th"),
